...
@Mapper(componentModel = "spring", uses = BookingAdvertCarpoolingMapper.class)
public interface AdvertCarpoolingMapper {
    ...
    AdvertCarpooling updateAdvertCarpooling(AdvertCarpoolingDto advertCarpoolingDto, @MappingTarget AdvertCarpooling advertCarpoolingToUpdate);
