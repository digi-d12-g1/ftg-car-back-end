...
public class VehicleController {
    ...
    @GetMapping("/booking/{departure}/{arrival}")
    public List<VehicleDto> findForBooking(@PathVariable Date departure, @PathVariable Date arrival) {
        return vehicleService.getVehiclesAvailableForBooking(departure, arrival);
    }
